...
#ifndef DUNAR_SOCKET_H
#define DUNAR_SOCKET_H
...
class Socket : public std::enable_shared_from_this<Socket>, Noncopyable {
 public:
  ...
  static Socket::ptr CreateTCP(dunar::Address::ptr address);
  static Socket::ptr CreateUDP(dunar::Address::ptr address);
